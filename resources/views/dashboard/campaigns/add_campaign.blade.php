                ...
                <div class="col-sm-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i> {{ __('Create Campaign') }}</div>
                        <div class="card-body mx-2">
                            <form method="POST" action="{{ route('campaigns.store') }}">
                                ...
                                <div class="form-group row">
                                    <label>CPC Bid</label>
                                    <input class="form-control" type="number" placeholder="{{ __('CPC Bid') }}" name="current_bid" required>
                                </div>
                                        ...
                                        @foreach($ad_formats as $ad_format)
                                            <div class="row mb-2" style="border-bottom: 1px solid #dedede;">
                                                <div class="col-md-6 my-2">
                                                    <input class="form-check-input" id="{{$ad_format->id }}" type="radio" value="{{ $ad_format->id }}" name="ad_format_id">
