                                ...
                                @foreach($campaigns as $campaign)
                                    <tr>
                                      ...
                                      {{ $campaign->status->name }}
                                        ...
                                        <td>
                                            <small>{{  substr($campaign->start, 0, 10) }}</small>
                                        </td>
                                        <td>
                                            @if ($campaign->trashed())
                                                Trashed
                                            @else
                                                <div class="row no-gutters">
                                                    ...
                                                    @if($campaign->status->name =="live")
                                                        ...
                                                        <div class=" no-gutters">
                                                            <form
                                                                action="{{ route('campaigns.edit_status', [$campaign->id,'completed']) }}"
                                                                method="POST">
                                                                @method('PUT')
                                                                @csrf
                                                                <button class="btn-sm  btn-block btn-info" title="Pause">
                                                    ...
                                                    @if ($campaign->creative && $campaign->status->name =="pending")
                                                        <div class=" no-gutters">
                                                            <form
