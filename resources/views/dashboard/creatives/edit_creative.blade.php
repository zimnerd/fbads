                            ...
                            <div class="card-body mx-2">
                                ...
                                <form method="POST" action="/creatives/{{ $creative->id }}" id="creatives_ss_form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <button class="btn btn-lg btn-success float-right" type="submit">{{ __('Submit for review') }}</button>
                                        </div>
                            ...
                            <div class="card-body mx-2">
                                ...
                                <form method="POST" action="/creatives/{{ $creative->id }}" id="creatives_form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6"><a href="{{ url('/campaigns/' . $campaign->id) }}" class="btn btn-lg btn-info float-left">{{ __('Return') }}</a></div>
                                        <div class="col-md-6">
                                            <button class="btn btn-lg btn-success float-right" type="submit">{{ __('Save creative') }}</button>
                                        </div>
    ...
    <script>
        ...
        Dropzone.options.dropzone = {
            ...
            removedfile: function (file) {
                ...
                $('#creatives_form').find('input[name="ad_media[]"][value="' + fileName + '"]').remove();
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': "{{ csrf_token() }}"
                    },
                    ...
                    success: function (data) {
                        $('#creatives_form').find('input[type="hidden"][value="' + name + '"]').remove();
                        console.log('File has been successfully removed!!', name);
